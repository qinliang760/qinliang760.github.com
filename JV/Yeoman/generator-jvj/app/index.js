...
JqueryGenerator.prototype.source = function source() {
  ...
  this.mkdir(this.pluginPath+'/src');
  this.copy('src/jshintrc', this.pluginPath+'/src/.jshintrc');
  this.copy('src/jquery-1.7.2.min.js', this.pluginPath+'/src/jquery-1.7.2.min.js');
  this.copy('src/jquery.namespace.js', this.pluginPath+'/src/jquery.namespace.js');
  this.copy('src/core.js', this.pluginPath+'/src/core.js');
  this.template('src/name.js', this.pluginPath+'/src/jquery.' + this.slugname + '.js');
};
