	...
	if ( !($.SyntaxHighlighter||false) ) {
		$.SyntaxHighlighter = {
			...
			'config': {
				 ...
				 */
				'prettifyBaseUrl': false ? '/css3/jquery-syntaxhighlighter/prettify' : '/css3/jquery-syntaxhighlighter/prettify',

				/**
				 * The baseUrl to load our Syntax Highlighter from.
				 * This is used to load in the stylesheet and additional themes.
				 */
				'baseUrl': false ? '/css3/jquery-syntaxhighlighter' : '/css3/jquery-syntaxhighlighter'
			},
