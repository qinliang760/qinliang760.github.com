    ...
    .directive('colorpicker', ['$document', '$compile', 'Color', 'Slider', 'Helper', function ($document, $compile, Color, Slider, Helper) {
      ...
      return {
        ...
        link: function ($scope, elem, attrs, ngModel) {
          //console.log(attrs.colorpicker)
          var inputColorHthml = "";
          if(attrs.colorpicker == "inputColor"){
            inputColorHthml = '<input class="u-plugin-color-input" type="text" ng-model="data.screen[index].text[subIndex].styles.color"/>';
            attrs.colorpicker = "";
          }
          var
