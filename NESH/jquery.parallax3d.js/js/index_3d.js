...
kg/parallax/2.0.0/helpers
kg/parallax/2.0.0/index
...
KISSY.add('kg/parallax/2.0.0/index',function(S,Node,DOM,Event,JSON,Helpers){
    ...
    Plugin.prototype.onAnimationFrame = function () {
        ...
        this.mx = this.ix * this.ew * (this.scalarX / 2.0.0) * -1;
        this.my = this.iy * this.eh * (this.scalarY / 2.0.0) * -1;
