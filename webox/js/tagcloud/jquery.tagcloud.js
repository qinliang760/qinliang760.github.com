...
//				var iUlH = oSettings.height===null?mUl.height():oSettings.height;
				...
				for (var j=0;j<iNumLi;j++) {
					...
					var iColor=mLi.attr("rel");
					//if (iColor>iValMx) iValMx = iColor;
					//if (iColor<iValMn) iValMn = iColor;					
					//var iValRn = iValMx-iValMn;					
					var fColor=(iColor-iValMn)/iValRn;

					//
					var iSzFnt = oSettings.sizemin + fPrt*(oSettings.sizemax-oSettings.sizemin);
					var sColor = colorRng(oSettings.colormin,oSettings.colormax,fColor);
					//
